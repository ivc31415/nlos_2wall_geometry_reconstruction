...
python main.py "data/cube/0.0_rec.npy" "data/cube/90.0_to_0.0_rec.npy" "-1 0 0" "0 0 1" "output/TEMP.obj" -i 10 --roomsize 4 -wlod0 1 -wlod1 2.5 -wlod2 2 -wlod3 7 -wn 2 -wp 1 -s 2
