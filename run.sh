...
python main.py "data/cube/0.0_rec.npy" "data/cube/90.0_to_0.0_rec.npy" "-1 0 0" "0 0 1" "output/TEMP.obj" -i 10 --roomsize 4 -wlod0 1 -wlod1 2 -wlod2 2 -wlod3 8 -wv 1 -wn 1 -wp 0 -wneigh 0 -s 1 -rm
