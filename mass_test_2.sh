...
for i in {0..3}; do
	...
	#
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.1"
	##run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.2" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.2"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.3" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.3"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.4" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.4"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.5" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.5"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.6" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.6"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.7" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.7"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.8" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.8"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_0.9" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.9"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/1_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.9_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.9 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.8_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.8 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.7_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.7 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.6_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.6 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.5_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.5 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.4_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.4 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.3_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.3 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.2_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.2 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0.1_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.1 -wv1 1"
	#run_test "$file1 $file2" "$_normal" "$output/volume_balance/0_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0 -wv1 1"

	#
	# Change power of each volume, with standard deviation size of the sphere
	#
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.2" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.2 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.3" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.3 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.4" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.4 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.5" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.5 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.6" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.6 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.7" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.7 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.8" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.8 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_0.9" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 0.9 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/1_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 1 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.9_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.9 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.8_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.8 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.7_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.7 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.6_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.6 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.5_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.5 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.4_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.4 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.3_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.3 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.2_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.2 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0.1_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0.1 -wv1 1 -fb"
	run_test "$file1 $file2" "$_normal" "$output/volume_balance_fb/0_1" "-i 10 --roomsize 4 -wlod0 4 -wlod1 3 -wlod2 2 -wlod3 1 -wv 1 -wn 0 -wneigh 0 -wp 0 -s 3 -wv0 0 -wv1 1 -fb"
done